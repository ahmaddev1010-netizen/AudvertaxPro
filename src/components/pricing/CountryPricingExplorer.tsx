              ...
              <div className="grid gap-fm-5 sm:grid-cols-2 lg:grid-cols-4">
                {markets.map((market, index) => (
                  <Card
                    ...
                    variant="interactive"
                    tone="dark"
                    className="group flex min-h-[280px] flex-col justify-between p-7"
                  >
                    <div>
                      <div className="flex items-center justify-between">
                        ...
                        <span className="font-mono text-[10px] font-bold uppercase tracking-[.14em] text-[var(--fm-text-tertiary)]">
                          {String(index + 1).padStart(2, "0")} /{" "}
                          {String(markets.length).padStart(2, "0")}
                        </span>
                      </div>
                      <h3 className="mt-8 font-display text-3xl font-extrabold tracking-[-.045em] text-[var(--fm-text-primary)]">
                        {market.name}
                      </h3>
                    ...
                    <button
                      type="button"
                      onClick={() => selectCountry(market.slug)}
                      className="mt-8 inline-flex items-center justify-between rounded-[var(--fm-radius-pill)] bg-[var(--fm-lime)] px-5 py-3.5 text-sm font-bold text-[var(--fm-graphite-deep)] transition-transform duration-[var(--fm-motion-component)] hover:-translate-y-px hover:bg-[var(--fm-lime-bright)]"
                    >
                      Explore{" "}
                      <ArrowRight
                        weight="bold"
